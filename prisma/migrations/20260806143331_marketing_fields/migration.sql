...
INSERT INTO "new_Game" ("canonical", "categoriaId", "createdAt", "descripcion", "descripcionAccesible", "descuento", "destacado", "dificultad", "disponibleMesa", "disponibleVenta", "duracion", "edad", "estado", "id", "imagen", "imagenAlt", "integrarVideo", "jugadoresMax", "jugadoresMin", "nombre", "nuevo", "orden", "precioFinalVenta", "precioReservaMesa", "resumenIA", "seoDescription", "seoKeywords", "seoTitle", "slug", "updatedAt", "videoUrl") SELECT "canonical", "categoriaId", "createdAt", "descripcion", "descripcionAccesible", "descuento", "destacado", "dificultad", "disponibleMesa", "disponibleVenta", "duracion", "edad", "estado", "id", "imagen", "imagenAlt", "integrarVideo", "jugadoresMax", "jugadoresMin", "nombre", "nuevo", "orden", "precioFinalVenta", "precioReservaMesa", "resumenIA", "seoDescription", "seoKeywords", "seoTitle", "slug", "updatedAt", "videoUrl" FROM "Game";
DROP TABLE "Game";
